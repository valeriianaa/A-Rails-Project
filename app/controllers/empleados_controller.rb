class EmpleadosController < ApplicationController
  ...
  private
    ...
    def empleado_params
      params.require(:empleado).permit(:nombre, :apellido, :nroIdentificacion, :fechaNacimiento, :calle, :nroDomicilio, :piso, :dpto, :telefono, :email, :type, :pais_id, :provincia_id, :ciudad_id, :area_id, :tipo_documento_id, :departamento_id)
