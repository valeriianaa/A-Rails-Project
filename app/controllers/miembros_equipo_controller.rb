class MiembrosEquipoController < ApplicationController
  ...
  private
    ...
    def miembro_equipo_params
      params.require(:miembro_equipo).permit(:nombre, :apellido, :nroIdentificacion, :fechaNacimiento, :calle, :nroDomicilio, :piso, :dpto, :telefono, :email, :type, :pais_id, :provincia_id, :ciudad_id, :tipo_documento_id)
