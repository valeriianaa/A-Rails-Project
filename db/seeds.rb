...
Persona.create!([
  ...
  {nombre: "Miguel", apellido: "Jablonski", nroIdentificacion: "34029649", fechaNacimiento: "1990-04-08", calle: "Los Llanos", nroDomicilio: "9026", piso: "9", dpto: "A", telefono: "423761", email: "migueljablonski@gmail.com", type: "MiembroEquipo", pais_id: 1, provincia_id: 1, ciudad_id: 2, tipo_documento_id: 1, departamento_id: nil, especialidad_de_contacto_id: nil, area_id: 1, rol_de_empleado_id: nil},
  ...
  {nombre: "Evelyn", apellido: "Matos", nroIdentificacion: "20467791", fechaNacimiento: "1968-09-13", calle: "Paseo", nroDomicilio: "6118", piso: "", dpto: "", telefono: "423649", email: "evelynmatos@gmail.com", type: "MiembroEquipo", pais_id: 1, provincia_id: 1, ciudad_id: 2, tipo_documento_id: 1, departamento_id: nil, especialidad_de_contacto_id: nil, area_id: 1, rol_de_empleado_id: nil},
  {nombre: "Yasmin", apellido: "Castro Pinto", nroIdentificacion: "33812221", fechaNacimiento: "1988-12-24", calle: "Córdoba", nroDomicilio: "2863", piso: "1", dpto: "B", telefono: "4593672", email: "yasmincp@gmail.com", type: "Contacto", pais_id: 1, provincia_id: 1, ciudad_id: 1, tipo_documento_id: 1, departamento_id: nil, especialidad_de_contacto_id: 1, area_id: 1, rol_de_empleado_id: nil},
  {nombre: "Rodrigo", apellido: "Fernandez", nroIdentificacion: "27098333", fechaNacimiento: "1983-03-05", calle: "Andalucia", nroDomicilio: "4068", piso: "", dpto: "", telefono: "4018366", email: "rodrifer@gmail.com", type: "Contacto", pais_id: 1, provincia_id: 1, ciudad_id: 1, tipo_documento_id: 1, departamento_id: nil, especialidad_de_contacto_id: 2, area_id: 1, rol_de_empleado_id: nil},
  {nombre: "Carlos", apellido: "Moreno", nroIdentificacion: "42773233", fechaNacimiento: "1982-06-13", calle: "Roque Pérez", nroDomicilio: "63", piso: "10", dpto: "12", telefono: "4563321", email: "carlosmoreno@gmail.com", type: "Contacto", pais_id: 1, provincia_id: 1, ciudad_id: 1, tipo_documento_id: 2, departamento_id: nil, especialidad_de_contacto_id: 3, area_id: 1, rol_de_empleado_id: nil}
])
CuotaPorCliente.create!([
  {mensaje: nil, montoTotal: 192.0, montoAcreditado: 0.0, concepto_de_pago_id: 1, persona_proyecto_id: nil, proyecto_id: 2, interes_id: 1, descuento_id: 1},
  {mensaje: nil, montoTotal: 240.0, montoAcreditado: 0.0, concepto_de_pago_id: 2, persona_proyecto_id: nil, proyecto_id: 2, interes_id: 1, descuento_id: nil},
...
EspecialidadDeContacto.create!([
  {nombre: "Diseño gráfico", descripcion: "Páginas web, banners, etc."},
  {nombre: "Programador web", descripcion: "Paginas y aplicaciones web"},
  {nombre: "Marketing", descripcion: "Marketing y Publicidad"}
])
Estado.create!([
  {nombre: "To do", ultimo: false, previous: nil, color: nil},
  {nombre: "Doing", ultimo: false, previous: 1, color: nil},
...
Evento.create!([
  {nombre: "Exposición de Marketing", descripcion: "-", dia: "2016-12-05", hora: "2000-01-01 07:23:00", contacto_id: nil, persona_id: 13}
])
EventoProyecto.create!([
  {proyecto_id: 2, evento_id: 1}
])
Interes.create!([
  {nombre: "Interes 20%", descripcion: "-", porcentaje: 20.0}
])
